...
parser.add_argument('--topic',
                      dest='topic',
                      required=True,
                      help='PubSub Topic to read data from')
...
topic=path_args.topic
dataset_id=path_args.dataset
schema='customer_id:STRING,datetime:STRING,order_id:STRING,items:STRING,amount:INTEGER,mode:STRING,restaurant:STRING,status:STRING,ratings:INTEGER,feedback:STRING'
